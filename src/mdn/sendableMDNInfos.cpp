...
sendableMDNInfos::sendableMDNInfos(const std::shared_ptr<const message> msg, const mailbox& mbox)
...
const std::shared_ptr<const message> sendableMDNInfos::getMessage() const
{
	return (m_msg);
}
