...
parserInputStreamAdapter::parserInputStreamAdapter(std::shared_ptr<seekableInputStream> stream)
	: m_stream(stream)
{
}
...
std::shared_ptr<seekableInputStream> parserInputStreamAdapter::getUnderlyingStream()
{
	return m_stream;
}
