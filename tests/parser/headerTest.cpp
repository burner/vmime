...
VMIME_TEST_SUITE_BEGIN
	...
	void testAppend1()
	{
		...
		std::shared_ptr<vmime::headerField> hf = vmime::headerFieldFactory::getInstance()->create("A", "a");
		hdr.appendField(hf);

		std::vector <std::shared_ptr<vmime::headerField> > res = hdr.getFieldList();
	...
	void testAppend2()
	{
		...
		std::shared_ptr<vmime::headerField> hf = vmime::headerFieldFactory::getInstance()->create("B", "b");
		hdr.appendField(hf);
	...
	void testRemoveField1()
	{
		...
		std::vector <std::shared_ptr<vmime::headerField> > res1 = hdr1.getFieldList();
		...
		std::vector <std::shared_ptr<vmime::headerField> > res2 = hdr2.getFieldList();
	...
	void testGetFieldAt()
	{
		...
		std::shared_ptr<vmime::headerField> res = hdr.getFieldAt(2);
	...
	void testFind1()
	{
		...
		std::shared_ptr<vmime::headerField> res = hdr.findField("B");
	...
	void testFindAllFields1()
	{
		...
		std::vector <std::shared_ptr<vmime::headerField> > res = hdr.findAllFields("B");
	...
	void testFindAllFields3()
	{
		...
		std::vector <std::shared_ptr<vmime::headerField> > res = hdr.findAllFields("C");
