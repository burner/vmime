...
VMIME_TEST_SUITE_BEGIN
	...
	void testConstructors()
	{
		...
		t4.appendWord(vmime::factory<vmime::word>::create(w2));
...
#undef DISPLAY_FORM
	...
	void testWordGenerateSpace()
	{
		...
		vmime::text txt;
		txt.appendWord(vmime::factory<vmime::word>::create("\xc3\x89t\xc3\xa9", "utf-8"));
		txt.appendWord(vmime::factory<vmime::word>::create("Fran\xc3\xa7ois", "utf-8"));
	...
	void testWordGenerateSpace2()
	{
		...
		vmime::text txt;
		txt.appendWord(vmime::factory<vmime::word>::create("Facture ", "utf-8"));
		txt.appendWord(vmime::factory<vmime::word>::create("\xc3\xa0", "utf-8"));
		txt.appendWord(vmime::factory<vmime::word>::create(" envoyer ", "utf-8"));
		txt.appendWord(vmime::factory<vmime::word>::create("\xc3\xa0", "utf-8"));
		txt.appendWord(vmime::factory<vmime::word>::create(" Martine", "utf-8"));
	...
	void testWhitespaceMBox()
	{
		...
		vmime::text txt;
		txt.appendWord(vmime::factory<vmime::word>::create("Achim ", "us-ascii"));
		txt.appendWord(vmime::factory<vmime::word>::create("Br\xc3\xa4ndt", "utf-8"));
