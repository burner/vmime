...
VMIME_TEST_SUITE_BEGIN
	...
	void testConstructors()
	{
		...
		t4.appendWord(std::make_shared<vmime::word>(w2));
...
#undef DISPLAY_FORM
	...
	void testWordGenerateSpace()
	{
		...
		vmime::text txt;
		txt.appendWord(std::make_shared<vmime::word>("\xc3\x89t\xc3\xa9", "utf-8"));
		txt.appendWord(std::make_shared<vmime::word>("Fran\xc3\xa7ois", "utf-8"));
	...
	void testWordGenerateSpace2()
	{
		...
		vmime::text txt;
		txt.appendWord(std::make_shared<vmime::word>("Facture ", "utf-8"));
		txt.appendWord(std::make_shared<vmime::word>("\xc3\xa0", "utf-8"));
		txt.appendWord(std::make_shared<vmime::word>(" envoyer ", "utf-8"));
		txt.appendWord(std::make_shared<vmime::word>("\xc3\xa0", "utf-8"));
		txt.appendWord(std::make_shared<vmime::word>(" Martine", "utf-8"));
	...
	void testWhitespaceMBox()
	{
		...
		vmime::text txt;
		txt.appendWord(std::make_shared<vmime::word>("Achim ", "us-ascii"));
		txt.appendWord(std::make_shared<vmime::word>("Br\xc3\xa4ndt", "utf-8"));
