...
#define PARAM_BUFFER(p, n) \
	...
	void testGenerate()
	{
		...
		parameterizedHeaderField p1;
		p1.appendParameter(vmime::factory<vmime::parameter>::create("param1", "value1"));

		VASSERT_EQ("1", "F: X; param1=value1", p1.generate());

		// Value that needs quoting (1/2)
		parameterizedHeaderField p2a;
		p2a.appendParameter(vmime::factory<vmime::parameter>::create("param1", "value1a;value1b"));

		VASSERT_EQ("2a", "F: X; param1=\"value1a;value1b\"", p2a.generate());

		// Value that needs quoting (2/2)
		parameterizedHeaderField p2b;
		p2b.appendParameter(vmime::factory<vmime::parameter>::create("param1", "va\\lue\"1"));
	...
	void testGenerateRFC2231()
	{
		...
		parameterizedHeaderField p1;
		p1.appendParameter(vmime::factory<vmime::parameter>::create("param1",
		...
		parameterizedHeaderField p2;
		p2.appendParameter(vmime::factory<vmime::parameter>::create("param1",
		...
		parameterizedHeaderField p3;
		p3.appendParameter(vmime::factory<vmime::parameter>::create("param1",
	...
	{
		VASSERT_EQ(" 1", "p=\"val(ue\"",
				vmime::factory<vmime::parameter>::create("p", "val(ue")->generate());
		VASSERT_EQ(" 2", "p=\"val)ue\"",
				vmime::factory<vmime::parameter>::create("p", "val)ue")->generate());
		VASSERT_EQ(" 3", "p=\"val<ue\"",
				vmime::factory<vmime::parameter>::create("p", "val<ue")->generate());
		VASSERT_EQ(" 4", "p=\"val>ue\"",
				vmime::factory<vmime::parameter>::create("p", "val>ue")->generate());
		VASSERT_EQ(" 5", "p=\"val@ue\"",
				vmime::factory<vmime::parameter>::create("p", "val@ue")->generate());
		VASSERT_EQ(" 6", "p=\"val,ue\"",
				vmime::factory<vmime::parameter>::create("p", "val,ue")->generate());
		VASSERT_EQ(" 7", "p=\"val;ue\"",
				vmime::factory<vmime::parameter>::create("p", "val;ue")->generate());
		VASSERT_EQ(" 8", "p=\"val:ue\"",
				vmime::factory<vmime::parameter>::create("p", "val:ue")->generate());
		VASSERT_EQ(" 9", "p=\"val/ue\"",
				vmime::factory<vmime::parameter>::create("p", "val/ue")->generate());
		VASSERT_EQ("10", "p=\"val[ue\"",
				vmime::factory<vmime::parameter>::create("p", "val[ue")->generate());
		VASSERT_EQ("11", "p=\"val]ue\"",
				vmime::factory<vmime::parameter>::create("p", "val]ue")->generate());
		VASSERT_EQ("12", "p=\"val?ue\"",
				vmime::factory<vmime::parameter>::create("p", "val?ue")->generate());
		VASSERT_EQ("13", "p=\"val=ue\"",
				vmime::factory<vmime::parameter>::create("p", "val=ue")->generate());
		VASSERT_EQ("14", "p=\"val ue\"",
				vmime::factory<vmime::parameter>::create("p", "val ue")->generate());
		VASSERT_EQ("15", "p=\"val\tue\"",
				vmime::factory<vmime::parameter>::create("p", "val\tue")->generate());
	}
	...
	void testEncodeTSpecialsInRFC2231()
	{
		VASSERT_EQ("1", "filename*=UTF-8''my_file_name_%C3%B6%C3%A4%C3%BC_%281%29.txt",
			vmime::factory<vmime::parameter>::create("filename", "my_file_name_\xc3\xb6\xc3\xa4\xc3\xbc_(1).txt")->generate());
	}
