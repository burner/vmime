...
public:
	...
	/** Return the authenticator object used with this service instance.
	  ...
	  */
	std::shared_ptr<const security::authenticator> getAuthenticator() const;
	...
	/** Set the authenticator object used with this service instance.
	  ...
	  */
	void setAuthenticator(std::shared_ptr<security::authenticator> auth);
	...
	/** Set the object responsible for verifying certificates when
	  ...
	  */
	void setCertificateVerifier(std::shared_ptr<security::cert::certificateVerifier> cv);
	...
	/** Set the factory used to create socket objects for this
	  ...
	  */
	void setSocketFactory(std::shared_ptr<socketFactory> sf);
	...
	/** Return the factory used to create socket objects for this
	  ...
	  */
	std::shared_ptr<socketFactory> getSocketFactory();
	...
	/** Set the factory used to create timeoutHandler objects for
	  ...
	  */
	void setTimeoutHandlerFactory(std::shared_ptr<timeoutHandlerFactory> thf);
	...
	/** Return the factory used to create timeoutHandler objects for
	  ...
	  */
	std::shared_ptr<timeoutHandlerFactory> getTimeoutHandlerFactory();
	...
	/** Get information about the connection.
	  ...
	  */
	virtual std::shared_ptr<connectionInfos> getConnectionInfos() const = 0;
...
private:
	...
	std::shared_ptr<timeoutHandlerFactory> m_toHandlerFactory;
};
