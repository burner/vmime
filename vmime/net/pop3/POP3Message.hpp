...
private:
	...
	//friend class vmime::creator;  // std::make_shared<POP3Message> TODO shared
...
private:
	...
	void fetch(std::shared_ptr<POP3Folder> folder, const int options);

	void onFolderClosed();

	std::weak_ptr<POP3Folder> m_folder;
	int m_num;
	uid m_uid;
	int m_size;
