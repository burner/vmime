...
public:
	...
	/** Return the next file in the list.
	  ...
	  */
	virtual std::shared_ptr<file> nextElement() = 0;
};
...
public:
	...
	virtual std::shared_ptr<utility::outputStream> getOutputStream() = 0;
};
...
public:
	...
	virtual std::shared_ptr<utility::inputStream> getInputStream() = 0;
};
...
public:
	...
	/** Return the parent directory of this file/directory.
	  ...
	  */
	virtual std::shared_ptr<file> getParent() const = 0;
	...
	/** Return an object capable of writing to this file.
	  ...
	  */
	virtual std::shared_ptr<fileWriter> getFileWriter() = 0;

	/** Return an object capable of reading from this file.
	  *
	  * @return file reader object
	  */
	virtual std::shared_ptr<fileReader> getFileReader() = 0;
	...
	/** Enumerate files contained in this directory.
	  ...
	  */
	virtual std::shared_ptr<fileIterator> getFiles() const = 0;
...
public:
	...
	/** Create a new file object from the specified path.
	  ...
	  */
	virtual std::shared_ptr<file> create(const file::path& path) const = 0;
