...
public:
	...
	/** Return the data contained in this attachment.
	  ...
	  */
	virtual const std::shared_ptr<const contentHandler> getData() const = 0;
	...
	/** Return the part in which the attachment has been found.
	  ...
	  * attached to a part
	  */
	virtual std::shared_ptr<const object> getPart() const = 0;
...
protected:
	...
	/** Generate the attachment in the specified body part.
	  ...
	  */
	virtual void generateIn(std::shared_ptr<bodyPart> parent) const = 0;
};
