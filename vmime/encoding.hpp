...
public:
	...
	/** Decide which encoding to use based on the specified data.
	  ...
	  */
	static const encoding decide(std::shared_ptr<const contentHandler> data, const EncodingUsage usage = USAGE_BINARY_DATA);
	...
	/** Decide which encoding to use based on the specified data and charset.
	  ...
	  */
	static const encoding decide(std::shared_ptr<const contentHandler> data, const charset& chset, const EncodingUsage usage = USAGE_BINARY_DATA);
	...
	/** Use encoderFactory to obtain an encoder/decoder object
	  ...
	  */
	std::shared_ptr<utility::encoder::encoder> getEncoder() const;
