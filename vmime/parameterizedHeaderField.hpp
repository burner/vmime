...
public:
	...
	/** Find the first parameter that matches the specified name.
	  ...
	  */
	std::shared_ptr<parameter> findParameter(const string& paramName) const;
	...
	/** Find the first parameter that matches the specified name.
	  ...
	  */
	std::shared_ptr<parameter> getParameter(const string& paramName);

	/** Add a parameter at the end of the list.
	  *
	  * @param param parameter to append
	  */
	void appendParameter(std::shared_ptr<parameter> param);
	...
	/** Insert a new parameter before the specified parameter.
	  ...
	  */
	void insertParameterBefore(std::shared_ptr<parameter> beforeParam, std::shared_ptr<parameter> param);
	...
	/** Insert a new parameter before the specified position.
	  ...
	  * @param param parameter to insert
	  */
	void insertParameterBefore(const int pos, std::shared_ptr<parameter> param);
	...
	/** Insert a new parameter after the specified parameter.
	  ...
	  * @throw exceptions::no_such_parameter if the parameter is not in the list
	  */
	void insertParameterAfter(std::shared_ptr<parameter> afterParam, std::shared_ptr<parameter> param);
	...
	/** Insert a new parameter after the specified position.
	  ...
	  * @param param parameter to insert
	  */
	void insertParameterAfter(const int pos, std::shared_ptr<parameter> param);
	...
	/** Remove the specified parameter from the list.
	  ...
	  * @throw exceptions::no_such_parameter if the parameter is not in the list
	  */
	void removeParameter(std::shared_ptr<parameter> param);
	...
	/** Return the parameter at the specified position.
	  ...
	  */
	const std::shared_ptr<parameter> getParameterAt(const int pos);
	...
	/** Return the parameter at the specified position.
	  ...
	  * @return parameter at position 'pos'
	  */
	const std::shared_ptr<const parameter> getParameterAt(const int pos) const;

	/** Return the parameter list.
	  *
	  * @return list of parameters
	  */
	const std::vector <std::shared_ptr<const parameter> > getParameterList() const;
