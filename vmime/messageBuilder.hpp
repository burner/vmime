...
public:
	...
	/** Attach a new object to the message.
	  ...
	  */
	void attach(std::shared_ptr<attachment> attach);

	/** Attach a new object to the message.
	  *
	  * @param attach new attachment
	  */
	void appendAttachment(std::shared_ptr<attachment> attach);
	...
	/** Return the attachment at the specified position.
	  ...
	  * @return attachment at the specified position
	  */
	std::shared_ptr<attachment> getAttachmentAt(const int pos);
	...
	/** Return the list of attachments.
	  ...
	  * @return list of attachments
	  */
	const std::vector <std::shared_ptr<attachment> > getAttachmentList();
	...
	/** Return the text part of the message.
	  ...
	  */
	std::shared_ptr<textPart> getTextPart();
	...
	/** Construct a new message based on the information specified
	  ...
	  */
	std::shared_ptr<message> construct() const;
...
private:
	...
	std::shared_ptr<textPart> m_textPart;

	std::vector <std::shared_ptr<attachment> > m_attach;
};
