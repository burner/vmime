...
public:
	...
	/** Attach a MDN request to the specified message.
	  ...
	  */
	static void attachMDNRequest(std::shared_ptr<message> msg, const mailboxList& mailboxes);
	...
	/** Attach a MDN request to the specified message.
	  ...
	  */
	static void attachMDNRequest(std::shared_ptr<message> msg, const mailbox& mbox);
	...
	/** Return a list of possible MDNs that can be generated
	  ...
	  */
	static const std::vector <sendableMDNInfos> getPossibleMDNs(const std::shared_ptr<const message> msg);
	...
	/** Test whether the specified message is a MDN.
	  ...
	  */
	static bool isMDN(const std::shared_ptr<const message> msg);
	...
	/** If the specified message is a MDN, return information
	  ...
	  */
	static receivedMDNInfos getReceivedMDN(const std::shared_ptr<const message> msg);
	...
	/** Check whether we need user confirmation for sending a MDN even
	  ...
	  */
	static bool needConfirmation(const std::shared_ptr<const message> msg);
	...
	/** Build a new MDN for the message. The resulting MDN can then be
	  ...
	  */
	static std::shared_ptr<message> buildMDN(const sendableMDNInfos& mdnInfos,
	                              const string& text,
	                              const charset& ch,
...
private:
	...
	static std::shared_ptr<bodyPart> createFirstMDNPart(const sendableMDNInfos& mdnInfos,
	                                         const string& text, const charset& ch);

	static std::shared_ptr<bodyPart> createSecondMDNPart(const sendableMDNInfos& mdnInfos,
	                                          const disposition& dispo,
	                                          const string& reportingUA,
	                                          const std::vector <string>& reportingUAProducts);

	static std::shared_ptr<bodyPart> createThirdMDNPart(const sendableMDNInfos& mdnInfos);
};
