...
public:
	...
	/** Test whether a body part is an attachment.
	  ...
	  */
	static bool isBodyPartAnAttachment(std::shared_ptr<const bodyPart> part, const unsigned int options = 0);
	...
	/** Return attachment information in the specified body part.
	  ...
	  */
	static std::shared_ptr<const attachment>
		getBodyPartAttachment(std::shared_ptr<const bodyPart> part, const unsigned int options = 0);
	...
	/** Find all attachments contained in the specified part
	  ...
	  */
	static const std::vector <std::shared_ptr<const attachment> >
		findAttachmentsInBodyPart(std::shared_ptr<const bodyPart> part, const unsigned int options = 0);
	...
	/** Find all attachments contained in the specified message.
	  ...
	  */
	static const std::vector <std::shared_ptr<const attachment> >
		findAttachmentsInMessage(std::shared_ptr<const message> msg, const unsigned int options = 0);
	...
	/** Add an attachment to the specified message.
	  ...
	  */
	static void addAttachment(std::shared_ptr<message> msg, std::shared_ptr<attachment> att);
	...
	/** Add a message attachment to the specified message.
	  ...
	  */
	static void addAttachment(std::shared_ptr<message> msg, std::shared_ptr<message> amsg);

protected:

	static std::shared_ptr<bodyPart> findBodyPart
